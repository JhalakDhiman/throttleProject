...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex p-10 gap-12 items-center border-b-2 border-richblack-600">
      <div>
        <img width="400px" height="400px" src={imageMap[item.image]}></img>
      </div>
      <div className=" flex flex-col gap-6 justify-between">
        <p className="text-[20px] font-semibold text-richblack-50 ">{item.name}</p>
        <p className="text-richblack-50 text-[18px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae aliquam maxime non modi pariatur? Ipsa error, labore nam repellendus sapiente quo quam fugit, quisquam ipsum quasi id doloribus temporibus expedita.</p>
